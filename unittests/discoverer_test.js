...
const discoverer_1 = require("../src/discoverer"); // Adjust the import according to your project structure
describe('Discoverer Module', () => {
    it('should discover a single .so file in a simple workspace', async () => {
        ...
        const discoveredFiles = await (0, discoverer_1.discoverSoFiles)(mockWorkspace);
...
//# sourceMappingURL=discoverer_test.js.map